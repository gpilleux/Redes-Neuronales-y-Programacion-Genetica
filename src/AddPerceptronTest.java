...
public class AddPerceptronTest {
	...
	public void feedTest(){
		...
		assertEquals(p1.getIn1(), 1);
		assertEquals(p1.getIn2(), 0);
		
		assertEquals(p2.getIn1(), 1);
		assertEquals(p2.getIn2(), 1);
		
		assertEquals(p3.getIn1(), 1);
		assertEquals(p3.getIn2(), 0);
	...
	public void addTest(){
		ap.feed(0, 0);
		assertEquals(ap.getSum(), 0);
		assertEquals(ap.getCarry(), 0);
		
		ap.feed(0, 1);
		assertEquals(ap.getSum(), 1);
		assertEquals(ap.getCarry(), 0);
